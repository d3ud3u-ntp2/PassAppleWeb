const translations = {
    en: {
        "title-index": "Select Your Fruit - 合格林檎",
        ...
        "share-prompt": "Share on SNS with hashtag #合格林檎!",
        "share-x": "Post to X",
        "saving": "Saving...",
        "app-name": "合格林檎",
        "terms-title": "Terms of Service - 合格林檎",
        "terms-empty": "The terms of service are being prepared.",
        "error-no-path": "Saved to server successfully, but no return path found!",
        "error-save": "Error saving to server.",
        "lang-en": "EN",
        "lang-ja": "JA",
        "about-header-1": "What is 合格林檎?",
        "about-desc-1": "合格林檎 is a popular good-luck charm for students. It is created by applying lettering tape to apples before they turn red, so that when they ripen, only the covered parts stay yellow. With this tool, anyone can easily create a wallpaper in the style of 合格林檎. We also plan to expand this concept to other fruits and vegetables! Please look forward to it.",
        "about-header-2": "How to use",
        "about-desc-2": "1. Select a fruit from the gallery.\n2. Draw your design with white ink on the black canvas.\n3. Click \"Save\" to process and download your final creation."
    },
    ja: {
        "title-index": "フルーツを選択 - 合格林檎",
        ...
        "result-title": "処理結果",
        "download": "結果をダウンロード",
        "share-prompt": "ハッシュタグ #合格林檎 をつけて、SNSに共有してね！",
        "share-x": "Xに投稿する",
        "saving": "保存中...",
        "app-name": "合格林檎",
        "terms-title": "利用規約 - 合格林檎",
        "terms-empty": "利用規約は準備中です。",
        "error-no-path": "サーバーに保存されましたが、返却パスが見つかりませんでした！",
        "error-save": "サーバーへの保存中にエラーが発生しました。",
        "lang-en": "英語",
        "lang-ja": "日本語",
        "about-header-1": "合格林檎とは？",
        ...
        "about-header-2": "使い方",
        "about-desc-2": "1. ギャラリーから好きなフルーツを選択します。\n2. 黒い画面に白い線で自由に描きます。\n3. 「保存」をクリックすると画像が処理され、結果をダウンロードできます。"
    },
    zh: {
        "title-index": "选择水果 - 合格林檎",
        "title-apple": "绘图 - 黑底白画",
        "about-app": "关于此应用",
        "select-fruit": "选择水果",
        ...
        "saving": "正在保存...",
        "app-name": "合格苹果",
        "terms-title": "服务条款 - 合格林檎",
        "terms-empty": "服务条款正在准备中。",
        ...
        "about-header-2": "如何使用",
        "about-desc-2": "1. 从画廊中选择一种水果。\n2. 在黑色画布上用白色线条绘图。\n3. 点击“保存”以处理并下载您的作品。"
    },
    ko: {
        "title-index": "과일 선택 - 合格林檎",
        ...
        "saving": "저장 중...",
        "app-name": "합격사과",
        "terms-title": "이용 약관 - 合格林檎",
        "terms-empty": "이용 약관을 준비 중입니다.",
        ...
        "about-desc-2": "1. 갤러리에서 과일을 선택합니다.\n2. 검은색 캔버스 위에 흰색 선으로 그림을 그립니다.\n3. '저장'을 클릭하여 이미지를 처리하고 다운로드합니다."
    },
    itl: {
        "title-index": "Фрукт к'алӽалч - 合格林檎",
        "title-apple": "К'иԓч - 合格林檎",
        ...
        "terms-title": "Условия использования - 合格林檎",
        "terms-empty": "Условия использования готовятся.",
        ...
        "lang-ko": "한국어",
        "lang-itl": "Итэнмэн",
        "about-header-1": "合格林檎 х'энаӽ?",
        "about-desc-1": "合格林檎 к'иԓч апп. Фрукт к'алӽалч к'иԓч.",
